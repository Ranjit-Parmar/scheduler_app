    ...
    <div className="space-y-4">
      <div className="bg-blue-50 p-5 rounded-lg text-gray-800 border border-blue-200 shadow-sm">
        ...
        <p className="mb-4 text-base">
          To see <strong>top-performing posts,</strong> choose a time period and sort by Likes, shares, etc. You can <strong>re-add posts to your queue</strong>one at a time or in bulk.
        </p>
      </div>
