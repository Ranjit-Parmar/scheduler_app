    ...
    <div className="space-y-8 ">
      ...
      <div className="bg-blue-50 p-5 rounded-lg text-sm text-gray-800 border border-blue-200 shadow-sm">
        ...
        <p className="mb-4 text-base">
          <strong>Social Networks</strong> is where you connect your social
          media accounts and activate profiles you want to post to.
        </p>
      ...
      <div className="bg-white border flex justify-between items-center border-gray-200 rounded-lg p-6 shadow-sm">
        <div>
          ...
          <p className="text-sm text-gray-700 mt-2">
            <strong>0 of 1</strong> profiles are activated for posting. Click
            profiles below to activate them.
          </p>
        </div>
