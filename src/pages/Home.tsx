...
const Home = () => {
  ...
  const brandLogos = [img_frame_24, img_frame_25, img_frame_26, img_frame_27];
  ...
  return (
    <div className="max-w-full">
      ...
      <section className="flex flex-row justify-between items-center px-8 py-16 max-w-full mx-auto w-full">
        <div className="flex flex-col gap-8 max-w-[588px]">
          ...
          <p className="text-lg font-normal leading-[27px]">
            Save hours each week by automating your social posts with Postly.
            Discover content, schedule it across all platforms, and watch your
            audience grow.
          </p>
      ...
      <section className="flex flex-row gap-4 px-8 py-16 max-w-full mx-auto w-full">
        <div
          className="rounded-t-[30px] flex flex-col items-center py-12 px-8 flex-1"
          style={{
      ...
      <section className="flex flex-col items-center py-16 px-8 max-w-full mx-auto w-full">
        ...
        <div className="flex flex-row gap-24 justify-center">
          {brandLogos.map((logo, index) => (
            <img key={index} src={logo} alt="Brand Logo" className="h-auto" />
          ))}
        </div>
      </section>
            ...
            {testimonials.slice(0, 3).map((testimonial) => (
              ...
              >
                ...
                <p className="text-base font-normal leading-6 text-center">
                  {testimonial.text
                    .split(
                      /(\bnow it takes 15 minutes!\b|\bEngagement went up 220%\b|\breach 4x\b|\b1k to 28k followers in 4 months!\b|\b70% more engagement across all platforms\b|\b2\.5x\b|\bautomate\b|\bscheduling\b)/
                    )
                    .map((part, index) => {
                      if (
                        [
                          "now it takes 15 minutes!",
                          "Engagement went up 220%",
                          "reach 4x",
                          "1k to 28k followers in 4 months!",
                          "70% more engagement across all platforms",
                          "2.5x",
                          "automate",
                          "scheduling",
                        ].includes(part)
            ...
            {testimonials.slice(3, 6).map((testimonial) => (
              ...
              >
                ...
                <p className="text-base font-normal leading-6 text-center">
                  {testimonial.text
                    .split(
                      /(\bsmooth\b|\b2\.5x\b|\bManaging 12\b|\bautomate\b|\bscheduling\b)/
                    )
                    .map((part, index) => {
                      if (
                        [
      ...
      <section className="flex flex-row justify-center gap-7 items-center pt-16 px-8 max-w-full mx-auto w-full">
        <div className="flex flex-col gap-6 max-w-[611px]">
          ...
          <p className="text-lg font-medium leading-[21px]">
            From content creation to analytics, Schedular helps you manage it
            all — fast and effortlessly.
          </p>
        ...
        <img src={img_frame_31} alt="Visual Calendar" className="h-auto" />
      </section>
      ...
      <section className="flex flex-row justify-center gap-7 items-center pt-16 px-8 max-w-full mx-auto w-full">
        ...
        <div className="flex flex-col gap-6 max-w-[611px]">
          ...
          <p className="text-lg font-medium leading-[21px]">
            Build consistency, save time, and grow your audience with tools that
            work smart - not hard.
          </p>
          <Button className="border border-[#03045E] w-2xs rounded-2xl text-[16px] text-[#03045E] hover:text-[#023e8a] hover:border-[#023e8a] hover:shadow-md font-bold px-6 py-3.5 ">
            Try it for FREE
