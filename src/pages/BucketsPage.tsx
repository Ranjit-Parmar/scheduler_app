...
const BucketsPage = () => {
  const videos = [
    { title: "1. How Buckets work", link: "#" },
    { title: "2. Creating a new Bucket", link: "#" },
    { title: "3. Making your Bucket seasonal", link: "#" },
    { title: "4. Linking Buckets to your Plan", link: "#" },
  ];
  return (
      ...
      <section>
        <h2 className="text-2xl font-bold text-gray-800 mb-6">
          How to manage your Post Buckets
        </h2>
