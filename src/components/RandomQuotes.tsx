...
// Tags Array
const tags = [
  "all", "art", "motivation", "philosophy", "happiness", "truth", "wisdom",
  "courage", "education", "confidence", "action", "success", "resilience",
...
const RandomQuotes = () => {
  ...
  return (
    <section className="p-6 bg-white rounded-xl shadow-md space-y-8">
      ...
      {/* Quotes Carousel */}
      <div className="relative">
        <h3 className="text-base font-semibold text-gray-700 mb-2">See All Quotes</h3>
        <button
